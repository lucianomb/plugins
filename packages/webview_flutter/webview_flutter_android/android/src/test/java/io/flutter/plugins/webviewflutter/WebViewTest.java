...
public class WebViewTest {
  ...
  @Mock public WebViewFlutterApiImpl mockFlutterApi;
  ...
  public void setUp() {
    ...
    testHostApiImpl = new WebViewHostApiImpl(testInstanceManager, mockWebViewProxy,
            mockContext, null, mockFlutterApi);
