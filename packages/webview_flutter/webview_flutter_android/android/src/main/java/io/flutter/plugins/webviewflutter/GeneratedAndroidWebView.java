...
public class GeneratedAndroidWebView {
  ...
  private static class WebViewFlutterApiCodec extends StandardMessageCodec {
    public static final WebViewFlutterApiCodec INSTANCE = new WebViewFlutterApiCodec();
    private WebViewFlutterApiCodec() {}
  }
  ...
  public static class WebViewFlutterApi {
    ...
    static MessageCodec<Object> getCodec() {
      return WebViewFlutterApiCodec.INSTANCE;
    }

    public void dispose(Long instanceIdArg, Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.WebViewFlutterApi.dispose", getCodec());
      channel.send(new ArrayList<Object>(Arrays.asList(instanceIdArg)), channelReply -> {
        callback.reply(null);
      });
    }
    public void onPageDidScroll(Long webViewInstanceIdArg, Double offsetArg, Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.WebViewFlutterApi.onPageDidScroll", getCodec());
      channel.send(new ArrayList<Object>(Arrays.asList(webViewInstanceIdArg, offsetArg)), channelReply -> {
        callback.reply(null);
      });
    }
  }
  ...
  public interface WebSettingsHostApi {
    ...
    void setMixedContentModeEnable(Long instanceId, Boolean enabled);
    ...
    static void setup(BinaryMessenger binaryMessenger, WebSettingsHostApi api) {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.WebSettingsHostApi.setMixedContentModeEnable", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
              ...
              api.setMixedContentModeEnable(instanceIdArg.longValue(), enabledArg);
              wrapped.put("result", null);
            }
            catch (Error | RuntimeException exception) {
              wrapped.put("error", wrapError(exception));
      ...
      } else 
{
  ...
  public static class WebViewClientFlutterApi {
    ...
    public void onURLChange(Long instanceIdArg, Long webViewInstanceIdArg, String urlArg, Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.WebViewClientFlutterApi.onURLChange", getCodec());
      channel.send(new ArrayList<Object>(Arrays.asList(instanceIdArg, webViewInstanceIdArg, urlArg)), channelReply -> {
        callback.reply(null);
      });
    }
  ...
  public static class WebChromeClientFlutterApi {
    ...
    public void onTitleChange(Long instanceIdArg, Long webViewInstanceIdArg, String titleArg, Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.WebChromeClientFlutterApi.onTitleChange", getCodec());
      channel.send(new ArrayList<Object>(Arrays.asList(instanceIdArg, webViewInstanceIdArg, titleArg)), channelReply -> {
        callback.reply(null);
      });
    }
  }
